...
class T {
  ...
  // Android bloqueando a permissão por o app ter vindo de fora da loja.
  String get restritoT => s('restritoT');
  String get restritoPor => s('restritoPor');
  String get restrito1 => s('restrito1');
  String get restrito2 => s('restrito2');
  String get restrito3 => s('restrito3');
  String get restrito4 => s('restrito4');
  String get restritoAbrir => s('restritoAbrir');
  String get restritoDepois => s('restritoDepois');
  String get restritoComo => s('restritoComo');
  ...
  String get celebChegada => s('celebChegada');
  String get celebChegadaSub => s('celebChegadaSub');
  ...
  String get comoMinutos => s('comoMinutos');
  String get comoTela => s('comoTela');
  String get comoApps => s('comoApps');
  String get comoSemana => s('comoSemana');
  String get missaoVamos => s('missaoVamos');
  String get notifSessaoTitulo => s('notifSessaoTitulo');
  String get notifSessaoCorpo => s('notifSessaoCorpo');
  String get vigiaFala => s('vigiaFala');
  String get vigiaSemPermissao => s('vigiaSemPermissao');
...
const _pt = <String, Object>{
  ...
  'seqT': 'Sua raiz',
  'seqSub': 'Cada dia presente aprofunda a raiz. É ela que segura o hábito no dia em que a vontade falta.',
  'seqAtual': 'RAIZ ATUAL',
  'seqMelhor': 'Raiz mais funda',
  'seqCongelamentos': 'Congelamentos',
  'seqCongelamentoAjuda': 'Um congelamento segura a raiz num dia em que você faltar. Volta a cada segunda.',
  'seqSemana': 'ESTA SEMANA',
  'seqSessoes': 'Sessões concluídas',
  'seqDiasAbaixo': 'Dias abaixo da meta',
  'seqProximo': 'Faltam {x} dias para {m}',
  'seqVaziaT': 'Sua raiz começa hoje',
  'seqVaziaB': 'Apareça amanhã e ela ganha o segundo dia.',
  ...
  'celebChegada': 'Você voltou',
  'celebChegadaSub': '{a} passou o dia esperando por isso.',
  ...
  'comoTela': 'Basta terminar o dia com menos tempo de tela que a sua meta.',
  'comoApps': 'Conta só o tempo nos apps marcados como dispersivos. Veja quais em Tempo.',
  'comoSemana': 'Vai somando sozinho até domingo. Não precisa fazer tudo hoje.',
  'missaoVamos': 'Vamos lá',
  'notifSessaoTitulo': '{n} está em foco',
  'notifSessaoCorpo': 'Deixe o telefone de lado. Volte quando acabar.',
  'vigiaFala': 'Ei, a gente estava focando junto.',
  'vigiaSemPermissao': 'Sem "desenhar sobre outros apps", não posso te chamar de volta. Ative em Ajustes › Sobreposição.',
  ...
  'restritoT': 'O Android bloqueou essa permissão',
  'restritoPor': 'Acontece quando o app é instalado por arquivo, fora da loja. O Android chama de "configuração restrita" e mostra aquele aviso sobre dados pessoais. Não é um problema do Baru — some quando o app vier da Play Store.',
  'restrito1': 'Abra Configurações › Apps › Baru',
  'restrito2': 'Toque nos três pontinhos, no canto de cima',
  'restrito3': 'Toque em "Permitir configurações restritas"',
  'restrito4': 'Volte aqui e toque em Permitir de novo',
  'restritoAbrir': 'Abrir os ajustes do Baru',
  'restritoDepois': 'Agora não',
  'restritoComo': 'Como liberar',
...
const _en = <String, Object>{
  ...
  'seqT': 'Your roots',
  'seqSub': 'Every day present deepens the roots. They are what holds the habit on the day the will does not.',
  'seqAtual': 'CURRENT ROOTS',
  'seqMelhor': 'Deepest roots',
  'seqCongelamentos': 'Freezes',
  'seqCongelamentoAjuda': 'A freeze holds your roots on a day you miss. It comes back every Monday.',
  'seqSemana': 'THIS WEEK',
  'seqSessoes': 'Sessions completed',
  'seqDiasAbaixo': 'Days under goal',
  'seqProximo': '{x} days to go for {m}',
  'seqVaziaT': 'Your roots start today',
  'seqVaziaB': 'Show up tomorrow and they gain a second day.',
  'vinculoRotulo': 'Bond',
  ...
  'celebChegada': 'You\'re back',
  'celebChegadaSub': '{a} spent the day waiting for this.',
  ...
  'comoTela': 'Just end the day with less screen time than your goal.',
  'comoApps': 'Only time in apps marked as distracting counts. See which ones under Time.',
  'comoSemana': 'It adds up on its own until Sunday. No need to do it all today.',
  'missaoVamos': 'Let\'s go',
  'notifSessaoTitulo': '{n} is focusing',
  'notifSessaoCorpo': 'Put the phone down. Come back when it ends.',
  'vigiaFala': 'Hey, we were focusing together.',
  'vigiaSemPermissao': 'Without \'draw over other apps\', I can\'t call you back. Turn it on in Settings › Overlay.',
  ...
  'restritoT': 'Android blocked this permission',
  'restritoPor': 'This happens when the app is installed from a file, outside the store. Android calls it a "restricted setting" and shows that warning about personal data. It is not a Baru problem — it goes away once the app comes from the Play Store.',
  'restrito1': 'Open Settings › Apps › Baru',
  'restrito2': 'Tap the three dots at the top corner',
  'restrito3': 'Tap "Allow restricted settings"',
  'restrito4': 'Come back here and tap Allow again',
  'restritoAbrir': 'Open Baru\'s settings',
  'restritoDepois': 'Not now',
  'restritoComo': 'How to unblock',
...
const _es = <String, Object>{
  ...
  'seqT': 'Tu raíz',
  'seqSub': 'Cada día presente ahonda la raíz. Es ella la que sostiene el hábito el día que falta la ganas.',
  'seqAtual': 'RAÍZ ACTUAL',
  'seqMelhor': 'Raíz más honda',
  'seqCongelamentos': 'Congelaciones',
  'seqCongelamentoAjuda': 'Una congelación sostiene la raíz un día que faltes. Vuelve cada lunes.',
  'seqSemana': 'ESTA SEMANA',
  'seqSessoes': 'Sesiones completadas',
  'seqDiasAbaixo': 'Días bajo la meta',
  'seqProximo': 'Faltan {x} días para {m}',
  'seqVaziaT': 'Tu raíz empieza hoy',
  'seqVaziaB': 'Aparece mañana y gana el segundo día.',
  'vinculoRotulo': 'Vínculo',
  'vinculoSub': '{n} mimos',
  ...
  'celebChegada': 'Volviste',
  'celebChegadaSub': '{a} pasó el día esperando esto.',
  ...
  'comoTela': 'Basta terminar el día con menos tiempo de pantalla que tu meta.',
  'comoApps': 'Solo cuenta el tiempo en apps marcadas como dispersivas. Míralas en Tiempo.',
  'comoSemana': 'Se va sumando solo hasta el domingo. No hace falta hacerlo todo hoy.',
  'missaoVamos': 'Vamos',
  'notifSessaoTitulo': '{n} está enfocado',
  'notifSessaoCorpo': 'Deja el móvil. Vuelve cuando termine.',
  'vigiaFala': 'Oye, estábamos enfocando juntos.',
  'vigiaSemPermissao': 'Sin "mostrar sobre otras apps", no puedo llamarte de vuelta. Actívalo en Ajustes › Superposición.',
  ...
  'restritoT': 'Android bloqueó este permiso',
  'restritoPor': 'Pasa cuando la app se instala desde un archivo, fuera de la tienda. Android lo llama "ajuste restringido" y muestra ese aviso sobre datos personales. No es un problema de Baru: desaparece cuando la app venga de Play Store.',
  'restrito1': 'Abre Ajustes › Apps › Baru',
  'restrito2': 'Toca los tres puntos, arriba a la derecha',
  'restrito3': 'Toca "Permitir ajustes restringidos"',
  'restrito4': 'Vuelve aquí y toca Permitir otra vez',
  'restritoAbrir': 'Abrir los ajustes de Baru',
  'restritoDepois': 'Ahora no',
  'restritoComo': 'Cómo desbloquear',
...
const _zh = <String, Object>{
  ...
  'seqT': '你的根',
  'seqSub': '每出现一天，根就扎深一点。愿望落空的那天，靠的就是它。',
  'seqAtual': '当前的根',
  'seqMelhor': '扎得最深的根',
  ...
  'comoTela': '只要今天的屏幕时间少于你的目标即可。',
  'comoApps': '只统计被标为分心的应用。可在“时间”里查看。',
  'comoSemana': '到周日为止会自动累计，不必今天全做完。',
  'missaoVamos': '去做',
  'notifSessaoTitulo': '{n} 正在专注',
  'notifSessaoCorpo': '把手机放下，结束后再回来。',
  'vigiaFala': '嘿，我们本来在一起专注。',
  'vigiaSemPermissao': '没有“显示在其他应用上层”权限，我无法把你叫回来。请在设置 › 悬浮窗中开启。',
  ...
  'restritoT': 'Android 阻止了这项权限',
  'restritoPor': '这在从文件安装、而非应用商店安装时会发生。Android 称之为“受限设置”，并显示关于个人数据的提示。这不是 Baru 的问题——从 Play 商店安装后就不会出现。',
  'restrito1': '打开 设置 › 应用 › Baru',
  'restrito2': '点右上角的三个点',
  'restrito3': '点“允许受限设置”',
  'restrito4': '回到这里，再点一次允许',
  'restritoAbrir': '打开 Baru 的设置',
  'restritoDepois': '暂不',
  'restritoComo': '如何解除',
