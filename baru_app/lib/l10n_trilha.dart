...
const textosDaTrilha = <String, Map<String, String>>{
  'pt': {
    ...
    'trilhaProntoTravado': 'Pronto, esperando a vez',
    'trilhaEsperaAVez': 'Já cumprido. Abre assim que você fechar o passo {n}.',
    'trilhaOuTambem': 'Ou, sem a permissão de uso:',
  ...
  'en': {
    ...
    'trilhaProntoTravado': 'Ready, waiting its turn',
    'trilhaEsperaAVez': 'Already done. It opens once you clear step {n}.',
    'trilhaOuTambem': 'Or, without usage access:',
  ...
  'es': {
    ...
    'trilhaProntoTravado': 'Listo, esperando su turno',
    'trilhaEsperaAVez': 'Ya cumplido. Se abre en cuanto cierres el paso {n}.',
    'trilhaOuTambem': 'O, sin el permiso de uso:',
  ...
  'zh': {
    ...
    'trilhaTravado': '未解锁',
    'trilhaProntoTravado': '条件已达成，等待轮到它',
    'trilhaEsperaAVez': '条件已达成。完成第 {n} 步后就会开启。',
    'trilhaOuTambem': '或者，在没有使用权限时：',
